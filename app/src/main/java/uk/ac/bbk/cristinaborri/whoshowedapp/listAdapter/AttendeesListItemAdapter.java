...
public class AttendeesListItemAdapter extends ArrayAdapter<Attendee> {
    ...
    public View getView(int position, View convertView, @NonNull ViewGroup parent) {
        ...
        TextView eventName = convertView.findViewById(R.id.listAttendeeName);
        eventName.setText(attendee != null ? attendee.getName() : null);
        TextView eventDate = convertView.findViewById(R.id.listAttendeeEmail);
        eventDate.setText(attendee != null ? attendee.getEmail() : null);
